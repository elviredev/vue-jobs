...
const handleSubmit = async () => {
  // créer un objet avec nos datas remplies
  const updatedJob = {
    type: form.type,
    title: form.title,
  ...
  // faire la requête pour update le form
  try {
...
// requête pour récupérer le formulaire rempli
onMounted(async () => {
  try {
    // requête axios
    const response = await axios.get(`/api/jobs/${jobId}`)
    // mettre à jour le state avec les data
